...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/axis-spring-boot-starter)](https://github.com/easy-4-java/axis-spring-boot-starter)
...
> **Artifact ID**：`axis-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**axis-spring-boot-starter** is a Spring Boot starter that integrates **axis** for applications using axis. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume axis capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using axis |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for axis |
| JDK | `17` |
| Coordinates | `io.github.easy4j:axis-spring-boot-starter:3.2.x.20260527-SNAPSHOT` |
| Config Prefix | `axis` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers axis beans automatically |
| Property Binding | ✅ Stable | Binds `axis.*` to `Properties` |
...
|---|---|---|:---:|---|:---:|
| `axis.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl axis-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `axis.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/axis-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/axis-spring-boot-starter)
